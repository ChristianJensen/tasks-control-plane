# Decomposition Validation: task-list-switcher-visibility

## Task Summary

| Wave | Repo | Task | Priority | Est. Lines |
|------|------|------|----------|------------|
| 1 | frontend | header-shows-active-list-name | high | 180 |
| 1 | frontend | switcher-dropdown-open-and-select | high | 280 |
| 1 | frontend | persist-and-restore-active-list | high | 200 |
| 1 | frontend | switcher-error-resilience | high | 180 |
| 1 | frontend | management-modal-sync-with-switcher | high | 200 |
| 1 | frontend | switcher-keyboard-a11y | high | 200 |

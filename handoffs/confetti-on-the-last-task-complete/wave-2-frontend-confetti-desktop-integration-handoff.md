...
## Resume Prompt
```
You are resuming work on branch agent/confetti-on-the-last-task-complete-w2-confetti-desktop-integration for task wave-2-frontend-confetti-desktop-integration.md.

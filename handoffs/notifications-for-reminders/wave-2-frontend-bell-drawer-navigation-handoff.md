...
## Resume Prompt
```
You are resuming work on branch agent/notifications-for-reminders-w2-bell-drawer-navigation for task wave-2-frontend-bell-drawer-navigation.md.
